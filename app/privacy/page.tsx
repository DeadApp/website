    ...
    <div className="mx-auto max-w-4xl px-4 py-8">
      ...
      <div className="mt-2 prose max-w-none space-y-6">
        ...
        <p className="text-zinc-200">
          ...
          This Privacy Policy explains how Dead (the "Service") available via
          our website{' '}
          <Link
          ...
          and the Dead mobile applications for iOS and Android collects, uses,
        ...
        <ul className="list-disc pl-6 my-2 text-zinc-200">
          ...
          <li>
            <strong>User Content:</strong> Jokes, feedback, or other content you
            submit via the app.
          </li>
          <li>
        ...
        <ul className="list-disc pl-6 my-2 text-zinc-200">
          ...
          <li>
            Process payments and manage subscriptions for premium joke packs.
          </li>
          <li>Personalize content and remember saved jokes.</li>
          <li>
            Send administrative messages, updates, and promotional offers (you
            may opt out).
          </li>
          <li>Analyze usage to improve features and develop new joke packs.</li>
          <li>
        ...
        <p className="text-zinc-200">
          ...
          platforms (e.g., social media for sharing images). We are not
          responsible for their content or privacy practices. Review their
          policies before interacting.
        </p>
